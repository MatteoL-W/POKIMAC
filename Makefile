...
render: main.o Game.o ExplorationInterface.o Map.o Pokemon.o Text.o
	$(CC) -o bin/$@ build/main.o build/Game.o build/ExplorationInterface.o build/Map.o build/Pokemon.o build/Text.o $(SDLFLAGS)
